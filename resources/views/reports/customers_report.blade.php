                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <select name="Section" class="form-control select2">
                                <option value="" disabled {{ empty($Section) ? 'selected' : '' }}>حدد القسم</option>
                                @foreach ($sections as $section)
                                    <option value="{{ $section->id }}" {{ $section->id == $Section ? 'selected' : '' }}>
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            ...
                            <select id="product" name="product" class="form-control select2">
                                <option value="" disabled {{ empty($product) ? 'selected' : '' }}>حدد المنتج</option>
                                @if (!empty($details))
                                    @foreach ($details as $detail)
                                        <option value="{{ $detail->product }}" {{ $detail->product == $product ? 'selected' : '' }}>
                                            {{ $detail->product }}
                                        </option>
                                    @endforeach
                                @endif
