                ...
                <div class="dropdown nav-item main-header-message ">
                 ...
                 <div class="dropdown nav-item main-header-notification">
                    <a class="new nav-link" href="#">
                        ...
                        <span id="notifications_count" class="badge badge-pill badge-danger">
                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <button id="markAllRead" class="badge badge-pill badge-warning mr-auto my-auto float-left"
                        ...
                        <div id="unreadNotifications">
                            @if(auth()->user()->unreadNotifications->count() > 0)
                                ...
                                @endforeach
                            @else
                                <div class="main-notification-list text-center p-3">
    ...
    document.getElementById('markAllRead').addEventListener('click', function () {
        ...
        .then(data => {
            if (data.success) {
                ...
                document.getElementById('notifications_count').innerText = '0';
